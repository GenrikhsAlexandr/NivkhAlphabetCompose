...
import com.aleksandrgenrikhs.nivkhalphabetcompose.utils.Constants.REPEAT_TASK_SCREEN
...
sealed class NavigationDestination(val destination: String) {
    ...
    data object RepeatTaskScreen : NavigationDestination(REPEAT_TASK_SCREEN)
